                    ...
                    <div class="card mt-3">
                        ...
                        <div class="header p-4 bg-color-base">
                            <div class="row d-flex justify-content-center">
                                <h3 class="white-text mb-3 font-bold" style="margin-bottom: 0 !important;"><?php echo $this->lang->line('Admin_Login'); ?></h3>
                            </div>
                        </div>
                        <!--Header-->
                        <div class="card-body mx-4 mt-4 resp_mx-0">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" placeholder="<?php echo $this->lang->line('Email'); ?>" id="username" name="username" value='<?php if (!empty($enter_email)) echo $enter_email; ?>' class="form-control">                                
                                <?php echo form_error('username'); ?>
                            </div>
                            <div class="form-group">
                                <label for="password"> <?php echo $this->lang->line('Password'); ?> <small class="required">*</small></label>
                                <input type="password" placeholder="<?php echo $this->lang->line('Password'); ?>" id="password" name="password" class="form-control">                                
                            ...
                            <div class="row d-flex align-items-center mb-4">
                                ...
                                <div class="col-md-7">
                                    <p class="font-small grey-text d-flex justify-content-end"> <a href="<?php echo base_url("admin_forgot-password"); ?>" class="dark-grey-text ml-1 font-bold"><?php echo $this->lang->line('Forgot_Password'); ?>?</a></p>
                                </div>
                            </div>
                            <!--Grid row-->
                            <?php echo form_close(); ?>
