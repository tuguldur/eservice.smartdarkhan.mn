...
$title = (set_value("title")) ? set_value("title") : $group_data['title'];
$group_icon = (set_value("group-icon")) ? set_value("group-icon") : $group_data['group_icon'];
$description = (set_value("description")) ? set_value("description") : $group_data['description'];
$seo_keyword = (set_value("seo_keyword")) ? set_value("seo_keyword") : $group_data['seo_keyword'];
$seo_description = (set_value("seo_description")) ? set_value("seo_description") : $group_data['seo_description'];
$status = (set_value("status")) ? set_value("status") : $group_data['status'];
$id = (set_value("id")) ? set_value("id") : $group_data['id'];
?>
                ...
                <div class="row">
                    <div class="col-md-8 m-auto">
                        ...
                        <div class="header pt-3 bg-color-base">
                            <div class="d-flex ">
                                <h3 class="white-text mb-3 font-bold"> Байгууллага засварлах</h3>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body mx-4 mt-4 resp_mx-0">
                                <?php echo form_open('save-group', array('name' => 'group_form', 'id' => 'group_form')); ?>
                                <?php echo form_input(array('type' => 'hidden', 'name' => 'id', 'id' => 'id', 'value' => $id)); ?>
                                <?php echo form_input(array('type' => 'hidden', 'name' => 'hidden_group_icon', 'id' => 'hidden_group_icon', 'value' => $group_icon)); ?>
                                <div class="form-group">
                                    <label for="title"> Нэр <small class="required">*</small></label>
                                    <input type="text" name='title' id="title" value="<?php echo $title; ?>" class="form-control" placeholder="Нэр ">                                    
                                    <?php echo form_error('title'); ?>
                                </div>
                                <div id="title_validate"></div>
                                <div class="form-group">
                                    <label>Байгууллагын лого<small class="required">*</small></label>
                                    <!-- own select -->
                                    <select id="icons-fa" class="kb-select initialized" name="group-icon" required="">
                                        <option value="" ><?php echo $this->lang->line('Select'); ?> <?php echo $this->lang->line('Icon'); ?> </option>
                                ...
                                <div id="group-icon_validate"></div>
                                <!-- Make an div for show icon-->
                                <div id="view-fa" style="text-align: left; font-size: 28px;display: none;"></div>
                                <div class="form-group">
                                    <label for="description">Байгууллагын тайлбар <small class="required">*</small></label>
                                    <br>
                                    <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name='seo_keyword' placeholder="Хайлтын түлхүүр үг" id="seo_keyword" value="<?php echo $seo_keyword; ?>" class="form-control">                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name='seo_description' id="seo_description" value="<?php echo $seo_description; ?>" class="form-control" placeholder="Хайлтын тайлбар">                                    
...
<script>
    $(document).ready(function () {
        var name = $("#hidden_group_icon").val();
        $('select[name="group-icon"] option[value="' + name + '"]').attr("selected", true);
        /* Detect any change of option*/
        $("#icons-fa").change(function () {
            var icono = $(this).val();
            $("#view-fa").html('<i class="fa ' + icono + '" style="border: 1px solid;padding: 12px;"></i>');
            if (icono != '') {
                $("#view-fa").show();
            } else {
                $("#view-fa").hide();
