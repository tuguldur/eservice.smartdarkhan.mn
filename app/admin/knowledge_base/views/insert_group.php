...
$group_icon = (set_value("group-icon")) ? set_value("group-icon") : "";
$description = (set_value("description")) ? set_value("description") : "";
$seo_keyword = (set_value("seo_keyword")) ? set_value("seo_keyword") : "";
$seo_description = (set_value("seo_description")) ? set_value("seo_description") : "";
$status = (set_value("status")) ? set_value("status") : "A";
$id = (set_value("id")) ? set_value("id") : 0;
?>
<style>
                ...
                <div class="row">
                    <div class="col-md-8 m-auto">
                        ...
                        <div class="header pt-3 bg-color-base">
                            <div class="d-flex">
                                <h3 class="white-text mb-3 font-bold">Байгууллага нэмэх</h3>
                            </div>
                        </div>
                        <div class="card">
