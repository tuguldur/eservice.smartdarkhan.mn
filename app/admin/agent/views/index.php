                        ...
                        <div class="header bg-color-base">
                            <div class="d-flex">
                                <span style="width: 70%;" class="text-left">
                                    <h3 class="white-text font-bold pt-3">Бүх үйлчилгээний ажилтан</h3>
                                </span>  
                                <span style="width: 30%;padding-right: 20px" class="text-right">
                                    <a  href='<?php echo base_url('add-agent'); ?>' class="btn-floating btn-sm btn-success"><i class="fa fa-plus-circle"></i></a>
                                </span>
                            </div>
                        </div>
                        <div class="card">
                                ...
                                <div class="table-responsive">
                                    <table class="table mdl-data-table" id="example">
                                        ...
                                        <tbody>
                                            <?php
                                            $i = 1;
                                            if (isset($agent_data) && count($agent_data) > 0) {
                                                foreach ($agent_data as $row) {
                                                    ...
                                                    if ($row['status'] == "A") {
                                                        ...
                                                        $status_string = '<span class="alert alert-warning">' . $this->lang->line('Warning') . '</span>';
                                                    }
                                                    ?>
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-center">
                                                            <a href="<?php echo base_url('update-agent/' . $row['id']); ?>" class="btn-danger btn-floating btn-sm blue-gradient" title="Edit"><i class="fa fa-pencil"></i></a>
                                                            <a id="" data-toggle="modal" onclick='DeleteRecord(this)' data-target="#delete-record" data-id="<?php echo (int) $row['id']; ?>" class="btn-danger btn-floating btn-sm red-gradient" title="Agent"><i class="fa fa-close"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $i++;
