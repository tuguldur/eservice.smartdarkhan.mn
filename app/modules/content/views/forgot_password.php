                    ...
                    <div class="col-md-5 m-auto">
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="header p-3 bg-color-base">
                                ...
                                <div class="text-center">
                                    <h3 class="white-text mb-0 font-bold"><?php echo $this->lang->line('Forgot_Password'); ?></h3>
                                </div>
                            </div>
                            <!--Header-->
                            <div class="card-body mx-4 mt-4 resp_mx-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" name="email"  value='<?php if (!empty($enter_email)) echo $enter_email; ?>'  class="form-control" placeholder="<?php echo $this->lang->line('Email'); ?>">                                
                                ...
                                <div class="row d-flex align-items-center mb-4">
                                    ...
                                    <div class="col-md-7">
                                        <p class="font-small grey-text d-flex justify-content-end mt-3"><?php echo $this->lang->line('Return'); ?> <a href="<?php echo base_url("login"); ?>" class="dark-grey-text ml-1 font-bold"> <?php echo $this->lang->line('Login'); ?></a></p>
                                    </div>
                                </div>
                                <!--Grid row-->
                                <?php echo form_close(); ?>
