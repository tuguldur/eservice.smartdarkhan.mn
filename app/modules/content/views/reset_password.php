                    ...
                    <div class="card">
                        ...
                        <div class="card-body mx-4 mt-4 resp_mx-0">
                            ...
                            <div class="row d-flex align-items-center mb-4">
                                ...
                                <div class="col-md-7">
                                    <p class="font-small grey-text d-flex justify-content-end mt-3"> <?php echo $this->lang->line('Now'); ?> <a href="<?php echo base_url("login"); ?>" class="dark-grey-text ml-1 font-bold"> <?php echo $this->lang->line('Login'); ?></a></p>
                                </div>
                            </div>
                            <!--Grid row-->
                            <?php echo form_close(); ?>
