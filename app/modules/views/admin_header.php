...
<html>
    ...
    <body>
        ...
        <?php
        include APPPATH . '/modules/views/admin_sidebar.php';
        ///////////////////////////////////////////////////////////
        ...
        <nav class="nav navbar py-3 white">
            <div class="container-fluid pr-0">
                ...
                <ul class="nav navbar-nav nav-flex-icons ml-auto sidbar_ulnav top_navbar">
                    <!-- Dropdown -->
                    <li class="nav-item">
                        <a  href="<?php echo base_url('admin-profile') ?>" class="<?php echo $profile_active; ?>  nav-link waves-effect text-muted"><i class="fa fa-user"></i> <span class="clearfix d-none d-sm-inline-block">ТАНЫ ТОХИРГОО</span></a>
                    </li>
                    <li class="nav-item">
                        <a  href="<?php echo base_url('admin-update-password-action') ?>" class="<?php echo $change_password_active; ?> nav-link waves-effect text-muted"><i class="fa fa-key"></i> <span class="clearfix d-none d-sm-inline-block">НУУЦ ҮГ СОЛИХ</span></a>
                    </li>
                    <li class="nav-item">
