                        ...
                        <div class = "card">
                            <div class = "frame ">
                                ...
                                if ($request_main['status'] != "S") {
                                    echo form_open_multipart('request-reply-send', array('name' => 'chat_form', 'id' => 'chat_form'));
                                    ?>
                                    <div>
                                        <div class="macro w-100 pt-4 pl-20" style="margin-top: auto;">                        
                                            <div class="w-100 text-r msg-type-box" style="background:whitesmoke !important;">
                                                <textarea class="mytext w-100 form-control" name='message' required='true' placeholder="Асуулт хариулт болон нэмэлт мэдээлэл бичих..." style="resize: none;height: 8rem;background:whitesmoke !important;"></textarea>
                                                ...
                                                <input type="file" name="get_attachment" id="get_attachment" style="display: none;"/>
                                ...
                                <div id='messageContainer'   class="auto_scroll">
                                    <?php if ($request_main['status'] == "S") { ?>
                                        <p class="alert alert-warning mt-4"><i class="fa fa-warning">&nbsp;</i>Таны захим зөвшөөрөл амжилттай олгогдлоо</p>
                                    <?php } ?>
                                    <ul class="list-inline px-3">
                                        ...
                                        if (isset($request_data) && count($request_data) > 0) {
                                            foreach ($request_data as $value) {
                                                ...
                                                if (file_exists(FCPATH . uploads_path . "/profiles/" . $get_request_user['profile_image']) && $get_request_user['profile_image'] != '') {
                                                    $user_src = base_url() . uploads_path . "/profiles/" . $get_request_user['profile_image'];
                                                } else {
                                                    $user_src = base_url() . img_path . "/user.png";
                                                }
                                                if ($value['user_type'] == "U") {
                                                    ?>
                                                    <li style="width:100%">
                                                        <div class="msj macro">
                                                            <div class="avatar">
                                                            ...
                                                            <div class="text text-l">
                                                                ...
                                                                <?php if ($value['attchment']) { ?>
                                                                    <p><a download href="<?php echo base_url() . uploads_path . "/request/" . $value['attchment']; ?>" style="text-decoration: none;"><i class="fa fa-paperclip"></i>&nbsp;<?php echo $this->lang->line('Attchment'); ?></a></p>
                                                                <?php } ?>
                                        ...
                                        if (file_exists(FCPATH . uploads_path . "/profiles/" . $request_main['profile_image']) && $request_main['profile_image'] != '') {
                                            $user_src = base_url() . uploads_path . "/profiles/" . $request_main['profile_image'];
                                        } else {
                                            $user_src = base_url() . img_path . "/user.png";
                                        }
                                        ?>
                                            ...
                                            <div class="msj macro">
                                                ...
                                                <div class="text text-l">
                                                    ...
                                                    <?php if ($request_main['attchment']) { ?>
                                                        <p><a download href="<?php echo base_url() . uploads_path . "/request/" . $request_main['attchment']; ?>" style="text-decoration: none;"><i class="fa fa-paperclip"></i>&nbsp;<?php echo $this->lang->line('Attchment'); ?></a></p>
                                                    <?php } ?>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">ЗӨВШӨӨРЛИЙН МЭДЭЭЛЭЛ</h4>
                                <table width="100%" cellpadding="12">
                                    ...
                                    <tr>
                                        <td>Цахим зөвшөөрөл хүссэн газар</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <?php
                                            if ($request_main['status'] == 'O') {
                                               echo($this->lang->line('Open'));
                                                
                                            } elseif ($request_main['status'] == 'P') {
                                                 echo($this->lang->line('Pending'));
                                               
                                            } else {
                                                 echo($this->lang->line('Solved'));
