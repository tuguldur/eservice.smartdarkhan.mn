                    ...
                    <div class="my-5">
                        <div class="form-inline">
                            <div class="logo">
                                ...
                                ?>
                                <img class="rounded-circle" src="<?php echo $logo_image; ?>" alt="Image" width="60" height="60">
                            </div>
                            <div class="user_name">
                                <h4>User Name<?php echo ucfirst($user_profile[0]['first_name']) . " " . ucfirst($user_profile[0]['last_name']); ?></h4>
                            </div>
                        </div>
                        <div class="form-inline">
