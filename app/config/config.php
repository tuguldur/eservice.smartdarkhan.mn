...
$config['root_dir'] = dirname(dirname(BASEPATH)) . '/';
/*
  |--------------------------------------------------------------------------
  | Index File
  |--------------------------------------------------------------------------
...
if ($config['base_url'] == ADMIN_PATH) {
    $new_url = str_replace('admin/', '', $config['base_url']);
}
$config['root_url'] = $new_url;
...
//$config['img_root_dir'] = dirname(dirname(BASEPATH)) . "/adminpanel/assets/images/background/";
